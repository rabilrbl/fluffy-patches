...
val removePlayStoreLicenseCheckPatch = bytecodePatch(
    ...
    execute {
        ...
        findClass("Lcom/pairip/licensecheck/LicenseClient;")!!
        ...
        findClass("Lcom/pairip/licensecheck/LicenseActivity;")!!
        ...
        findClass("Lcom/pairip/SignatureCheck;")!!
        ...
        findClass("Lcom/pairip/StartupLauncher;")!!
